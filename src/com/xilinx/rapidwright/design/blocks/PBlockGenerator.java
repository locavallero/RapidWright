...
public class PBlockGenerator {
	...
	public static final String GLOBAL_PBLOCK_OPT 	  = "p";  //  File contaning already implemented pblocks for free resources computation
	...
	public static void main(String[] args) {
		...
		for(String s : pbGen.generatePBlockFromReport(fileName, shapesReportFileName)){
			...
			//crea un file con le s
			//togli il ciclo, non mi serve
			alreadySeen.add(s);
			requested--;
